...
export const OrderSummary = () => {
  ...
  return (
    <div className="grow rounded-lg border border-gray-700 bg-gradient-to-br from-sky-800 to-cyan-800 p-4 text-white">
      ...
      <div className="flex flex-col justify-center text-center">
        ...
        <div className="mt-10 flex self-center">
          <Button
            variant="green"
            className="h-30 text-2xl transition duration-150 ease-in-out"
