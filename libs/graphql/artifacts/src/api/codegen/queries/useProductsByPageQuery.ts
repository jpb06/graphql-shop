...
type ProductsByPageSelectorResult = Pick<QuerySelectorResult, 'productsByPage'>['productsByPage'];

export type ProductsByPageResult<Selector> = {
  productsByPage: DeepReplace<Selector, ProductsByPageSelectorResult>;
};

export const useProductsByPagePartialQuery = <Selector extends Pick<QuerySelector, 'productsByPage'>['productsByPage']>(
...
>
  ...
  return useQuery<ProductsByPageResult<Selector>, unknown, ProductsByPageResult<Selector>>({
