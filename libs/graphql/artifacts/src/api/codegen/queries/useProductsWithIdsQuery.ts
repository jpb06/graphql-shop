...
type ProductsWithIdsSelectorResult = Pick<
  QuerySelectorResult,
  'productsWithIds'
>['productsWithIds'];
...
export const useProductsWithIdsPartialQuery = <
  Selector extends Pick<QuerySelector, 'productsWithIds'>['productsWithIds']
>(
  selector: Selector,
  ...
  >({
    ...
    queryFn: useFetchData<ProductsWithIdsResult<Selector>>(document).bind(
      null,
      variables,
      undefined
    ),
