...
export const useProductPartialQuery = <Selector extends Pick<QuerySelector, 'product'>['product']>(
  selector: Selector, variables: ProductQueryArgs,
  options?: Omit<
  UseQueryOptions<
    ProductResult<Selector>,
    unknown,
    ProductResult<Selector>
  >,
  'queryFn' | 'queryKey'
>
  ...
  return useQuery<ProductResult<Selector>, unknown, ProductResult<Selector>>({
    ...
    queryFn: useFetchData<ProductResult<Selector>>(document).bind(null, variables, undefined),
    ...options
  });
};
