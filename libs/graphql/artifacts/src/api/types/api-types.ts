...
export interface Query { products: Array<GqlProductWithCategory>; productsByPage: (input: GqlPaginatedProductsInput) => GqlPaginatedProductsOutput; productsWithIds: (ids: Array<number>) => Array<GqlProductWithCategory>; product: (id: number) => GqlProductWithCategory; categories: Array<GqlCategoryWithProducts>; category: (id: number) => GqlCategoryWithProducts; me: GqlLoggedUser; getOrder: (id: number) => GqlUserOrder; myOrders: Array<GqlOrder>; myAddresses: Array<GqlAddress>; }
export interface GqlPaginatedProductsInput { offset: 0; limit: 25; categoriesIds?: Array<number>; text?: string; price?: number; priceCondition?: NumberCondition; availableStock?: boolean; field?: SortField; direction?: SortDirection; }
...
export type ProductsByPageQueryArgs = { input: GqlPaginatedProductsInput };
