...
import GraphqlLogo from '@front/assets/technos-icons/graphql.svg';
import JotaiLogo from '@front/assets/technos-icons/jotai.png';
import NestLogo from '@front/assets/technos-icons/nest.svg';
import NextLogo from '@front/assets/technos-icons/next.svg';
import NxLogo from '@front/assets/technos-icons/nx.png';
import ReactQueryLogo from '@front/assets/technos-icons/react-query.svg';
import ReactLogo from '@front/assets/technos-icons/react.svg';
import TailwindLogo from '@front/assets/technos-icons/tailwind.svg';
import TypeGraphqlLogo from '@front/assets/technos-icons/typegraphql.png';
